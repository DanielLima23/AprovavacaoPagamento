...
@Component({
  selector: 'app-administracao-terceiros-funcionario-funcionario-conta',
  templateUrl: './funcionario-conta.component.html',
  styleUrls: ['./funcionario-conta.component.scss']
})
export class AdministracaoTerceirosFuncionarioFuncionarioContaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.contaTerceiro.terceiro.id = parseInt(this.idFuncionario.toString(), 10)
