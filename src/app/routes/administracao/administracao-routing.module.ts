...
{ path: 'funcionario-consultar', component: AdministracaoTerceirosFuncionarioFuncionarioConsultarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'funcionario-adicionar', component: AdministracaoTerceirosFuncionarioFuncionarioAdicionarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'funcionario-adicionar/:id', component: AdministracaoTerceirosFuncionarioFuncionarioAdicionarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'funcionario-conta', component: AdministracaoTerceirosFuncionarioFuncionarioContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'funcionario-conta/:id', component: AdministracaoTerceirosFuncionarioFuncionarioContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'funcionario-conta/:id/:idConta', component: AdministracaoTerceirosFuncionarioFuncionarioContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },

{ path: 'fornecedor-adicionar', component: AdministracaoTerceirosFornecedorFornecedorAdicionarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'fornecedor-adicionar/:id', component: AdministracaoTerceirosFornecedorFornecedorAdicionarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'fornecedor-consultar', component: AdministracaoTerceirosFornecedorFornecedorConsultarComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'fornecedor-conta', component: AdministracaoTerceirosFornecedorFornecedorContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'fornecedor-conta/:id', component: AdministracaoTerceirosFornecedorFornecedorContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
{ path: 'fornecedor-conta/:id/:idConta', component: AdministracaoTerceirosFornecedorFornecedorContaComponent,canActivate: [authGuard],  data: { roles: [0,1,3,4,6] } },
