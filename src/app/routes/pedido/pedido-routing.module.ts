...
{ path: 'funcionario', component: PedidoFuncionarioComponent, canActivate: [authGuard],  data: { roles: [1] } },
...
{ path: 'funcionario-consultar', component: PedidoFuncionarioConsultarComponent, canActivate: [authGuard],  data: { roles: [1] } }
];
