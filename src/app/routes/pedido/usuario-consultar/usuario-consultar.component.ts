...
@Component({
  selector: 'app-pedido-usuario-consultar',
  templateUrl: './usuario-consultar.component.html',
  styleUrls: ['./usuario-consultar.component.scss']
})
export class PedidoUsuarioConsultarComponent implements OnInit {
  ...
  adicionar() {
    this.router.navigate(['/pedido/usuario']);
  }
